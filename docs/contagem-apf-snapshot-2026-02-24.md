...
- Data/hora do snapshot: **2026-02-24 18:50:55 -0300**
- Commit analisado: **`ced2887`**
...
| Endpoints API (`[HttpGet/Post/Put/Delete/Patch]`) | 328 |
| Endpoints GET | 162 |
| Endpoints POST | 126 |
| Endpoints PUT | 22 |
| Endpoints DELETE | 18 |
...
A recontagem total e completa para o snapshot de hoje (commit `ced2887`) confirma o baseline APF em **2.474 PF nao ajustados** e **2.870 PF ajustados**.
